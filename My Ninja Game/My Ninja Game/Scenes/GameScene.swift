...
extension GameScene {
    ...
    func setupTimer() {
        ...
        let cloudRandom = CGFloat.randon(min: 5.5, max: 10.5)
    ...
    @objc func spawnClouds() {
        ...
        let randomY = CGFloat.randon(min: -cloud.frame.height, max: cloud.frame.height*2.0)
